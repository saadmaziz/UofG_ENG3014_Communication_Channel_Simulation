...
if __name__ == "__main__":
    ...
    startTime = 0 
    simulationTimeStep = 1/(10*downlinkCarrierFreq) 
    ...
    print(f"Baud Rate: {downlinkBaud}")
    print(f"Sampling Rate: {int(fs)}")
    print(f"Oversampling Factor: {int(fs/downlinkBaud)}")
    print("-" * 50)
    ...
    while packet_idx < nPackets:
        ...
        while retries <= MAX_RETRIES and not success:
            ...
            noisy_sig = add_awgn_noise(faded_sig, target_snr, downlinkBaud, fs)
    ...
    # Reconstruction and Reporting Phase
